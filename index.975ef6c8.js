...
refs.searchBoxEl.addEventListener("input", (0, _lodashDebounceDefault.default)((event)=>{
    const enteredValue = event.target.value;
    if (enteredValue.trim() === "") {
        clearCountryList();
        return;
    }
    (0, _fetchCountriesDefault.default)(enteredValue.trim(), refs.countryListEl);
}, DEBOUNCE_DELAY));
function clearCountryList() {
    refs.countryListEl.innerHTML = "";
}

},{"./css/styles.css":"1CY4s","./fetch-countries":"7ur9R","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"7ur9R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");
function fetchCountries(name, ref) {
